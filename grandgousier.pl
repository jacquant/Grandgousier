...
nom_vins_uniforme(Lmots,L_mots_unif) :-
   ...
   replace_vin([savigny,les,beaune,'1er',cru,2014], savigny_les_beaune_1er_cru_2014, L33, L34),
   replace_vin([aloxe,corton,2014], aloxe_corton_2014, L34, L35),
   replace_vin([nuits,saint,georges,'1er',cru,2013], nuits_saint_georges_1er_cru_2013, L35, L36),
   replace_vin([chambolle,musfigny,'1er',cru,2012], chambolle_musfigny_1er_cru_2012, L36, L37),
   replace_vin([chiroubles,2013], chiroubles_2013, L37, L38),
   replace_vin([fleurie,2015], fleurie_2015, L38, L39),
   replace_vin([moulin,a,vent,2014], moulin_a_vent_2014, L39, L40),
   replace_vin([chinon,vieilles,vignes,2014], chinon_vieilles_vignes_2014, L41, L42),
   replace_vin([sancerre,rouge,2015], sancerre_rouge_2015, L42, L43),
   replace_vin([les,guignards,2015], les_guignards_2015, L43, L44),
   replace_vin([chardonnay,exception,2016], chardonnay_exception_2016, L44, L45),
   replace_vin([vire,clesse,2016], vire_clesse_2016, L45, L46),
   replace_vin([sancerre,blanc,2015], sancerre_blanc_2015, L46, L47),
   replace_vin([vacqueyras,2016], vacqueyras_2016, L47, L48),
   replace_vin([hautes,cotes,de,beaume,2015], hautes_cotes_de_beaume_2015, L48, L49),
   replace_vin([pouilly,fuisse,2014], pouilly_fuisse_2014, L49, L50),
   replace_vin([chablis,'1er',cru,montmains,2014], chablis_1er_cru_montmains_2014, L50, L51),
   replace_vin([condrieu,2015], condrieu_2015, L51, L52),
   replace_vin([cremant,de,loire,brut], cremant_de_loire_brut, L52, L53),
   replace_vin([champagne,brut,reserve], champagne_brut_reserve, L53, L54),
   replace_vin([champagne,extra,brut], champagne_extra_brut, L54, L55),
   replace_vin([champagne,brut,oeil,de,perdrix], champagne_brut_oeil_de_perdrix, L55, L56),
   replace_vin([champagne,brut,rose,de,saignee], champagne_brut_rose_de_saignee, L56, L57),
   replace_vin([champagne,brut,or,blanc], champagne_brut_or_blanc, L57, L58),
   replace_vin([champagne,brut,prestige], champagne_brut_prestige, L58, L59),
   replace_vin([cognac,trois,etoiles], cognac_trois_etoiles, L59, L60),
   replace_vin([cognac_fine_champagne,2016], cognac_fine_champagne, L60, L61),
   replace_vin([coganc,grand,champagne], cognac_grand_champagne, L61, L62),
